...
const MemberIntroSection = () => {
  ...
  return (
    <div className='bg-primary'>
      <section className='bg-Gray_light relative flex min-h-screen w-full flex-col justify-center overflow-hidden rounded-t-[60px] py-50'>
        {/* 1. 좌측 상단 (Flower) */}
        <img
          src={BgFlower}
          alt='background deco'
          className='pointer-events-none absolute top-0 left-0 z-0 w-40 select-none md:w-100 lg:w-150'
        />
        ...
        <img
          src={BgBottomD}
          alt='background deco'
          className='pointer-events-none absolute top-0 right-0 z-0 w-40 select-none md:w-100 lg:w-150'
        />
        ...
        <img
          src={BgTopD}
          alt='background deco'
          className='pointer-events-none absolute bottom-0 left-0 z-0 w-40 select-none md:w-100 lg:w-150'
        />
        ...
        <img
          src={BgRock}
          alt='background deco'
          className='pointer-events-none absolute right-0 bottom-0 z-0 w-40 select-none md:w-100 lg:w-150'
        />
        ...
        <div className='relative z-10 w-full'>
          ...
          <div className='z-10 px-4 py-5 text-center'>
            <p className='text-80 text-sm font-normal'>
              카드를 <span className='text-primary-light'>클릭</span>하여
              부원들의 이야기를 만나보세요.
            </p>
          </div>
        </div>
